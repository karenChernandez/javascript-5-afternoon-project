...
const Karen = new Employee("Hello", "World", "lol@lol.com", 2398234089);
console.log(Karen)
...
// const Manager2 = new Manager("Hello", "World", "lol@lol.com", 2398234089);
...
console.log('?',this.employee, this.reports)
super.hire(employee)
...
class Machine{
  constructor(widgets_made_count, wear_and_tear_count, needs_reboot){
    super(widgets_made_count, wear_and_tear_count, needs_reboot);
    this.widgets_made_count = 0,
    this.wear_and_tear_count = 0,
    this.needs_reboot = false
}
function makeWidgets(number) {
  return number += widgets_made_count

}
function fixMachine(){
  return needs_reboot = true;
  reboot()
}
function reboot() {
  return function(){
